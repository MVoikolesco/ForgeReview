...
func builtInContracts() []contractSeed {
	return []contractSeed{
		...
		{"review_findings", `Responda somente JSON: {"group_id":"...","reviewed_files":["path"],"findings":[{"id":"...","file":"path","line":1,"end_line":1,"severity":"critica|alta|media|baixa","category":"...","confidence":0.0,"decision_reason":"...","comment":"...","title":"...","evidence":"...","failure_scenario":"...","suggested_fix":"...","source_group_id":"...","introduced_by_pr":true}],"review_summary":"..."}. Reporte somente linhas adicionadas no diff.`, `{"type":"object","required":["findings"]}`, "review_findings"},
		{"consolidated_findings", `Responda somente JSON: {"findings":[{"id":"...","file":"path","line":1,"end_line":1,"severity":"critica|alta|media|baixa","category":"...","confidence":0.0,"decision_reason":"...","comment":"...","title":"...","evidence":"...","failure_scenario":"...","suggested_fix":"...","source_group_id":"...","source_finding_ids":["id"],"introduced_by_pr":true}],"pr_summary":"...","overall_risk":"baixo|medio|alto|critico","discarded_findings":[{"source_finding_id":"...","reason":"..."}]}. Preserve apenas achados comprovados no diff.`, `{"type":"object","required":["findings"]}`, "consolidated_findings"},
